      ...
      <form @submit.prevent="submit" class="space-y-5 bg-white p-4 shadow-xl rounded-2xl">
        ...
        <div class="flex gap-4">
          <div class="w-1/2">
            ...
            <input v-model="form.price" type="number" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
          ...
          <div class="w-1/2">
            ...
            <input v-model="form.discount_price" type="number" id="discount_price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
            dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
            <p v-if="form.errors.discount_price">{{ form.errors.discount_price }}</p>
          </div>
        </div>
